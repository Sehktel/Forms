...
tt_prod.forEach((prod) => {
  prod.prof.forEach((profile) => {
    //debugger;
    if (profile.need_arm) {
      armir = prod.arm.find((arm) => {
        if (arm.elm == profile.elm) {
          return true;
        }
      });
      if (armir) {
...
function draw_row_name(row_product, table_div, picture, prod_info) {
  ...
  table_row.innerHTML = `
                <td colspan = '05'> </td>
                <td colspan = '75'><b>Профили</b></td>
                `;
  table_body.tBodies[0].appendChild(table_row);
  table_row = document.createElement("tr");
  table_row.innerHTML = `
                    <td colspan = '04' style=" border-color:black; border-width : 1px; border-style: solid" >Тип</td>
                    <td colspan = '24' style=" border-color:black; border-width : 1px; border-style: solid" >Название</td>
                    ...
                    <td colspan = '07' style=" border-color:black; border-width : 1px; border-style: solid" >Длинна</td>
                    <td colspan = '05' style=" border-color:black; border-width : 1px; border-style: solid" >Углы</td>
  ...
  prod_info.prof.forEach((profile) => {
    ...
    if (profile.need_arm) { //Армировка нужна
      table_row.innerHTML = `
                    ...
                    <td colspan = '24' style=" border-color:black; border-width : 1px; border-style: solid" >#nfn#</td>
                    <td colspan = '15' style=" border-color:black; border-width : 1px; border-style: solid" >#art#</td>
                    <td colspan = '05' style=" border-color:black; border-width : 1px; border-style: solid" >#or_pos#</td>

                    <td colspan = '07' style=" border-color:black; border-width : 1px; border-style: solid" ><b>#len#</b></td>
                    <td colspan = '05' style=" border-color:black; border-width : 1px; border-style: solid" >#ang#</td>
      ...
      table_row.innerHTML = `
                    ...
                    <td colspan = '32' style=" border-color:black; border-width : 1px; border-style: solid" ></td>
                    `
      table_line = profile;
    }
    table_row.innerHTML = dhx4.template(table_row.innerHTML, table_line);
  ...
  table_row = document.createElement("tr");
  table_row.innerHTML = `
                    <td colspan = '28' style=" border-color:black; border-width : 1px; border-style: solid" >Название</td>
                    <td colspan = '16' style=" border-color:black; border-width : 1px; border-style: solid" >Артикул</td>
                    ...
                    <td colspan = '16' style=" border-color:black; border-width : 1px; border-style: solid" >Длинна</td>
                `;
  ...
  prod_info.sh.forEach((shtapik) => {
    table_row = document.createElement("tr");
    table_row.innerHTML = `
                    <td colspan = '28' style=" border-color:black; border-width : 1px; border-style: solid" >#nfn#</td>
                    <td colspan = '16' style=" border-color:black; border-width : 1px; border-style: solid" >#art#</td>
                    ...
                    <td colspan = '16' style=" border-color:black; border-width : 1px; border-style: solid" >#len#</td>
                `;
    //                    <td colspan = 30 style="width:37.5%; border-color:black; border-width : 1px; border-style: solid" ></td>
  ...
  .then((print_data) => {
    ...
    obj.production.forEach((row) => {
      ...
      if (row.characteristic.coordinates._obj.length) {
        //debugger;
        ff_prod = tt_prod.find((p) => {
          if (p.ref == row.characteristic) {
            return true;
          }
        });

        hide = draw_row_name(row, tabel_div, tpl_picture, ff_prod);
      } else {
        hide = true;
      }
      ...
      if (hide) {
        ...
        tpl_product.children.product.children.space_row_name.innerHTML = "";
